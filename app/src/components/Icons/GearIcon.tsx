...
// Material Design "settings" glyph (Apache-2.0, material-icons `settings`) — a
// cog, the conventional settings affordance. Authored on a 24×24 viewBox; the
// Svg scales it to `size`.
const GEAR_PATH =
  "M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14" +
  ...
  "-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l" +
  "-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 " +
  "3.6-1.62 3.6-3.6 3.6z";

/** Settings cog (Material icon), colourable for the Settings tab. */
