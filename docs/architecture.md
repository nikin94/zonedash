...
| `finish` | Pairing: end the round early at the current bound count, keeping every bind (`PairingRound::finish()`); the complement of `extend` | Control: FinishPairing (no payload) |
